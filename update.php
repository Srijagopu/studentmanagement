...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE user SET username=?, email=?, phone=?, password=?, class=?, section=? WHERE username=?";
    $stmt = $data->prepare($sql);
    $stmt->bind_param("sssssss", $newUsername, $newEmail, $newPhone, $newPassword, $newClass, $newSection, $username);
